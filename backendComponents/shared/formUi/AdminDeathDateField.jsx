...
const AdminDeathDateField = function (
  ...
  const [select, setSelect] = useState(
    defaultSelect === "alive" || defaultDateValue === "unknown"
      ? defaultSelect
      : "date"
  );
  const ref = useRef();
  ...
  return (
    ...
    >
      ...
      <div className="mt-2 flex gap-2 flex-wrap">
        ...
        <button
          type="button"
          onClick={() => handleOptionChange("alive")}
          className={`py-1 px-2 hover:opacity-80 duration-100 border-emerald-700 border text-sm ${
            select === "alive"
...
export default forwardRef(AdminDeathDateField);
