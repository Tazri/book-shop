...
function AdminAuthorsPagination({ pagination }) {
...
function PageButtion({ page, active, perPage = 5, searchText = "" }) {
  ...
  return (
    <li>
      <Link
        href={baseUrl + "/xyz/admin/authors?" + queryString}
...
function PrevButton({ isActive, perPage = 5, page = 1, searchText = "" }) {
  const baseUrl = process.env.NEXT_PUBLIC_BASE_URL;
  const searchParams = new URLSearchParams();
  searchParams.set("perPage", perPage);
  searchParams.set("page", page);
  ...
  return (
    <li className="select-none">
      <Link
        href={baseUrl + "/xyz/admin/authors?" + queryStr}
...
function NextPage({ isActive, perPage = 5, page = 1, searchText = "" }) {
  const baseUrl = process.env.NEXT_PUBLIC_BASE_URL;
  const searchParams = new URLSearchParams();
  searchParams.set("perPage", perPage);
  searchParams.set("page", page);
...
export default AdminAuthorsPagination;
