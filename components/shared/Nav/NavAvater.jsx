  ...
  return (
    <>
      ...
      >
        ...
        <div className="bg-white absolute right-0  s1230:left-1/2 text-[#333333] s1230:-translate-x-1/2 top-[120%] border w-24 md:w-32 flex flex-col p-3 overflow-hidden scale-y-0 duration-200 hover:scale-y-100 peer-focus:scale-y-100 origin-top">
          <Link
            href="/profile"
            className="hover:text-primary text-xs sm:text-sm md:text-base"
          >
            Profile
          </Link>
          <button className="text-left hover:text-primary text-xs sm:text-sm md:text-base">
            Log out
          </button>
        </div>
      </div>
